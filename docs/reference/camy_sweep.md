...
the inbox dial — off · shadow · suggest · auto
...
```
camy sweep                       the dial and what each notch does
camy sweep set suggest           one card a day, you approve the batch
camy sweep review                every call it made, restorable
```
...
* [camy sweep restore](camy_sweep_restore.md)	 - Bring a filed batch (or items) back
* [camy sweep review](camy_sweep_review.md)	 - Every call the sweep made, restorable
* [camy sweep set](camy_sweep_set.md)	 - Move the dial
