...
Who can reach a published site

```
camy canvas access SITE [flags]
```
...
* [camy canvas access set](camy_canvas_access_set.md)	 - who can open a site — public today; passcode and unlisted are not available yet
