...
```
camy keys                        every key on the account
camy keys rotate ky_007a         a new secret, shown once
camy keys revoke ky_007a         dead in seconds everywhere
```
