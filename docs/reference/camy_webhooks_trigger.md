## camy webhooks trigger

Synchronous test delivery through the real path

```
camy webhooks trigger ID [flags]
```

### Examples

```
  camy webhooks trigger wh_a1b2        # the short id the list prints
```
