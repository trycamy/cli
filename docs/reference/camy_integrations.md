...
Connected accounts, with health

```
camy integrations [flags]
```
...
* [camy integrations connect](camy_integrations_connect.md)	 - Connect an account — a link opens, you sign in there, camy waits
* [camy integrations health](camy_integrations_health.md)	 - Shallow health across providers
