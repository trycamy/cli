## camy approvals answer

Answer a question/choice/form checkpoint — --wait streams the resumed turn here

```
camy approvals answer ID TEXT... [flags]
```

### Examples

```
  camy approvals answer ap_789a yes, ship it
  camy approvals answer ap_789a "see it" --wait   # the id, then the answer
```
