...
Remove the local key; --revoke also kills it server-side

```
camy auth logout [flags]
```

### Options

```
      --confirm string   confirmation word for --revoke in scripts
  -h, --help             help for logout
      --revoke           also revoke the key server-side
```
