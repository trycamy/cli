...
Custom domain for a published site

```
camy canvas domain SITE [flags]
```
...
* [camy canvas domain set](camy_canvas_domain_set.md)	 - Attach a custom domain — --clear removes it
* [camy canvas domain verify](camy_canvas_domain_verify.md)	 - Check the pending DNS TXT challenge
