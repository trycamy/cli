...
how deep it thinks — agent · quick

```
camy mode [agent|quick] [flags]
```

### Examples

```
camy mode                        how deep Camy thinks right now
camy mode quick                  fast, few tools · camy mode agent for the full set
```
