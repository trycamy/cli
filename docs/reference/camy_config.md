...
Settings — get, set, unset, list, edit
...
* [camy config edit](camy_config_edit.md)	 - Open config.toml in $EDITOR
* [camy config get](camy_config_get.md)	 - Read one setting
* [camy config list](camy_config_list.md)	 - Effective values, defaults included
* [camy config set](camy_config_set.md)	 - Write one setting
* [camy config unset](camy_config_unset.md)	 - Clear one setting back to its default
