...
Link this Mac to your Camy account — zero capabilities until you grant one

```
camy device enroll [flags]
```
...
```
  -h, --help           help for enroll
      --label string   override the machine's default label ("MacBook Air")
```
